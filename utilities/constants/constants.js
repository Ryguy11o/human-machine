...
const dialog_arr = [
  ...
  'Awesome! Now, the first thing we will do is helping you understand more about your fear in communications. Okay?',
  ...
  'Perfect! Let me see… Umm… when it comes to public speaking, you may disturb by negative thoughts. For instance, I might think, like “I am going to embarrass myself in front of humans”. Do you feel the same?',
  ...
  'Excellent! Let’s move on to deal with it together. Are you with me？',
  ...
  'Next, to keep your audience on track, umm… you can use one sentence to summarize your point. Could you please do it?',
  'I know you can do it well! How do you think about it',
...
const NEGATIVE_CHOICE_DIALOGS = {
  ...
  //I’m a loser compared with my classmates.
